...
public class RoundImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    private void setCustomAttributes(AttributeSet attrs) {
        TypedArray a = mContext.obtainStyledAttributes(attrs, R.styleable.rounded_image_view);
        mBorderThickness = a.getDimensionPixelSize(R.styleable.rounded_image_view_border_thickness, 1);
