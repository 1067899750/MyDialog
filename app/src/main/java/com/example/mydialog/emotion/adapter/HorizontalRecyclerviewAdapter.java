package com.example.mydialog.emotion.adapter;
...
import com.example.mydialog.untils.emotion.ScreenUtils;
...
public class HorizontalRecyclerviewAdapter extends RecyclerView.Adapter<HorizontalRecyclerviewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        if (model.isSelected) {
            holder.imageBtn.setBackgroundColor(Color.parseColor("#70a3a4a7"));
        } else {
